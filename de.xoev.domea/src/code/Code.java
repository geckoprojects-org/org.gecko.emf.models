 ...
 * </p>
 * <ul>
 *   <li>{@link code.Code#getCode <em>Code</em>}</li>
 *   <li>{@link code.Code#getName <em>Name</em>}</li>
 *   <li>{@link code.Code#getListURI <em>List URI</em>}</li>
 *   <li>{@link code.Code#getListVersionID <em>List Version ID</em>}</li>
 * </ul>
 *
 * @see code.CodePackage#getCode()
...
public interface Code extends EObject {
	 ...
	 * @see #setCode(String)
	 * @see code.CodePackage#getCode_Code()
	...
	/**
	 * Sets the value of the '{@link code.Code#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see code.CodePackage#getCode_Name()
	...
	/**
	 * Sets the value of the '{@link code.Code#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see code.CodePackage#getCode_ListURI()
	...
	/**
	 * Sets the value of the '{@link code.Code#getListURI <em>List URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see code.CodePackage#getCode_ListVersionID()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.NormalizedString"
	...
	/**
	 * Sets the value of the '{@link code.Code#getListVersionID <em>List Version ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
