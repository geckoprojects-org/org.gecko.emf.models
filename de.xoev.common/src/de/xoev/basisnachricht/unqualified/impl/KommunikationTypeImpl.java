 ...
 * </p>
 * <ul>
 *   <li>{@link de.xoev.basisnachricht.unqualified.impl.KommunikationTypeImpl#getKanal <em>Kanal</em>}</li>
 *   <li>{@link de.xoev.basisnachricht.unqualified.impl.KommunikationTypeImpl#getKennung <em>Kennung</em>}</li>
 *   <li>{@link de.xoev.basisnachricht.unqualified.impl.KommunikationTypeImpl#getZusatz <em>Zusatz</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KommunikationTypeImpl extends MinimalEObjectImpl.Container implements KommunikationType {
	...
	protected EClass eStaticClass() {
		return UnqualifiedPackage.Literals.KOMMUNIKATION_TYPE;
	}
	...
	public NotificationChain basicSetKanal(CodeKommunikationKanalType newKanal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL, oldKanal, newKanal);
	...
	public void setKanal(CodeKommunikationKanalType newKanal) {
		if (newKanal != kanal) {
			...
			if (kanal != null)
				msgs = ((InternalEObject)kanal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL, null, msgs);
			if (newKanal != null)
				msgs = ((InternalEObject)newKanal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL, null, msgs);
			msgs = basicSetKanal(newKanal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL, newKanal, newKanal));
	}
	...
	public void setKennung(String newKennung) {
		...
		kennung = newKennung;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnqualifiedPackage.KOMMUNIKATION_TYPE__KENNUNG, oldKennung, kennung));
	}
	...
	public void setZusatz(String newZusatz) {
		...
		zusatz = newZusatz;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnqualifiedPackage.KOMMUNIKATION_TYPE__ZUSATZ, oldZusatz, zusatz));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnqualifiedPackage.KOMMUNIKATION_TYPE__KANAL:
				return getKanal();
			case UnqualifiedPackage.KOMMUNIKATION_TYPE__KENNUNG:
				return getKennung();
			case UnqualifiedPackage.KOMMUNIKATION_TYPE__ZUSATZ:
				return getZusatz();
		}
