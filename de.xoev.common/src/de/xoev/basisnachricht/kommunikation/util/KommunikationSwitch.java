 ...
 * @generated
 */
public class KommunikationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KommunikationPackage.CODE_KOMMUNIKATION_KANAL_TYPE: {
			...
			case KommunikationPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KommunikationPackage.KOMMUNIKATION_TYPE: {
