 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.dd.di.LabeledShape#getOwnedLabel <em>Owned Label</em>}</li>
 * </ul>
 *
 * @see org.omg.dd.di.DiPackage#getLabeledShape()
 * @model abstract="true"
...
public interface LabeledShape extends Shape {
	 ...
	 * @see org.omg.dd.di.DiPackage#getLabeledShape_OwnedLabel()
