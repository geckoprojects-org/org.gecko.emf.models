...
public class BpmnDiPackageImpl extends EPackageImpl implements BpmnDiPackage {
	 ...
	 * @see org.omg.bpmn.di.BpmnDiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getBPMNPlane_BpmnShape() {
		return (EReference)bpmnPlaneEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getBPMNPlane_BpmnEdge() {
		return (EReference)bpmnPlaneEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(bpmnPlaneEClass, BPMN_PLANE__BPMN_SHAPE);
		createEReference(bpmnPlaneEClass, BPMN_PLANE__BPMN_EDGE);
	...
	public void initializePackageContents() {
		...
		initEReference(getBPMNPlane_BpmnShape(), this.getBPMNShape(), null, "bpmnShape", null, 0, -1, BPMNPlane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getBPMNPlane_BpmnEdge(), this.getBPMNEdge(), null, "bpmnEdge", null, 0, -1, BPMNPlane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
